...
<div id="admin-content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <a class="add-new" href="fees-insert.php" style="border-radius:16px; margin-bottom:25px">Add Fees
                    Structure</a>
            </div>
            <div class="col-md-12" style="overflow:scroll">
                        ...
                        if (mysqli_num_rows($result_sql_show_user) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result_sql_show_user)) {
                                ...
                                <tr>
                                    ...
                                    <td class='edit'><a href='fees-update.php?id=<?php echo ($row["pid"]) ?>'><i
                                                class='fa fa-edit'></i></a></td>
                                    <td class='delete'><a href='fees-delete.php?id=<?php echo ($row["pid"]) ?>'><i
                ...
                <?php
                $sql_user_show_by_page = "SELECT * FROM pdf WHERE active_record = 'Yes' AND ptype = 'Fees'";
                ...
                if (mysqli_num_rows($result_sql_user_show_by_page) > 0) {
                    ...
                    if ($page_num_index_by_addbar > 1) {
                        echo ("<li><a href='fees-read.php?page_num_index=" . ($page_num_index_by_addbar - 1) . "'>Prev</a></li>");
                    }
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        echo ("<li class=$active_page><a href='fees-read.php?page_num_index=$i'>$i</a></li>");
                    }
                    if ($page_num_index_by_addbar < $total_page) {
                        echo ("<li><a href='fees-read.php?page_num_index=" . ($page_num_index_by_addbar + 1) . "'>Next</a></li>");
                    }
                    echo ("</ul>");
                }
                ?>
