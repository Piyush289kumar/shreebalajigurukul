		...
		<?php
                ...
                if (mysqli_num_rows($result_sql_user_show_by_page) > 0) {
                    ...
                    if ($page_num_index_by_addbar > 1) {
                        echo ("<li><a href='campus.php?page_num_index=" . ($page_num_index_by_addbar - 1) . "'>Prev</a></li>");
                    }
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        echo ("<li class=$active_page><a href='campus.php?page_num_index=$i'>$i</a></li>");
                    }
                    if ($page_num_index_by_addbar < $total_page) {
                        echo ("<li><a href='campus.php?page_num_index=" . ($page_num_index_by_addbar + 1) . "'>Next</a></li>");
                    }
                    echo ("</ul>");
                }
                ?>
